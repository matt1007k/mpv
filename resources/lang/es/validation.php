...
return [
    ...
    'attributes' => [
        ...
        'data.attributes.date' => 'fecha',
        'data.attributes.address' => 'dirección',
        'data.attributes.reference' => 'referencia',
        'data.attributes.department' => 'departamento',
        'data.attributes.province' => 'provincia',
        'data.attributes.district' => 'distrito',
