<div class="block md:hidden fixed z-10 bottom-0 right-0 left-0 bg-white p-6">
    <div class="flex items-center justify-between w-full">

        <a href="{{ route('dashboard') }}"
            class="py-3 px-4 flex items-center justify-center bg-indigo-100 rounded-full cursor-pointer space-x-2 @if(Request::routeIs('dashboard'))text-indigo-500 @else text-gray-500 @endif">
            ...
            @endif
            <span class="font-medium">Docum...</span>
        </a>
        ...
        <a href="#"
            ...
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M16 7a4 4 0 1 1-8 0 4 4 0 0 1 8 0zm-4 7a7 7 0 0 0-7 7h14a7 7 0 0 0-7-7z" /></svg>
            @else
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
