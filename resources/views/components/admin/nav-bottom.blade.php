<div class="block md:hidden fixed z-10 bottom-0 right-0 left-0 bg-white px-6 py-3">
    <div class="flex items-center justify-between w-full">
        ...
        <a href="{{ route('admin.users.index') }}"
            class="flex items-center justify-center  rounded-full cursor-pointer space-x-2 @if(Request::routeIs('admin.users.index')) py-3 px-4 bg-indigo-100 text-indigo-500 @else p-3 bg-gray-100 text-gray-400 @endif">
            ...
            <span class="font-medium text-xs">Usuari...</span>
            @else
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
