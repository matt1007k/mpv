<x-page-layout>
    ...
    <div class="wrapper px-6 sm:px-8 md:px-40 mt-4 flex justify-center">
        <div class="w-full md:w-1/2 bg-white shadow border border-gray-100 p-5 rounded-xl">
            ...
            <h4 class="mb-12 text-center">Registro completado con éxito</h4>
            <a href="{{ route('index') }}"
                class="flex items-center justify-center px-4 py-2 bg-indigo-500 hover:bg-indigo-600 text-white text-base font-medium rounded w-full">Registrar
                otro</a>
        </div>
    </div>
</x-page-layout>